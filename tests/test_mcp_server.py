...
class TestMCPServer:
    ...
    def test_execute_tool_check_policy(self):
        ...
        server = MCPServer()
        result = server.execute_tool("chiron_check_policy", {"config_path": "/path/to/config.yaml"})
    ...
    def test_execute_tool_get_feature_flags_with_module(self):
        ...
        with patch("chiron.mcp.server.get_feature_flags") as mock_flags:
            mock_feature_manager = Mock()
            mock_feature_manager.is_enabled = Mock(return_value=True)
            mock_flags.return_value = mock_feature_manager
    ...
    def test_execute_tool_get_feature_flags_without_module(self):
        ...
        with patch("chiron.mcp.server.get_feature_flags", side_effect=ImportError()):
            result = server.execute_tool("chiron_get_feature_flags", {})
...
class TestMCPServerIntegration:
    ...
    def test_full_workflow(self):
        ...
        bundle_result = server.execute_tool("chiron_create_airgap_bundle", {
    ...
    def test_multiple_tool_executions(self):
        ...
        results.append(server.execute_tool("chiron_build_wheelhouse", {"dry_run": True}))
        results.append(server.execute_tool("chiron_create_airgap_bundle", {"dry_run": True}))
