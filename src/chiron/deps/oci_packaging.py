...
class OCIPackager:
    ...
    WHEELHOUSE_MEDIA_TYPE = "application/vnd.chiron.wheelhouse.v1.tar+gzip"
    ...
    def create_oci_artifact(
        ...
        manifest = {
            ...
            "annotations": {
                ...
                "org.opencontainers.image.authors": "Chiron",
    ...
    def push_to_registry(
        ...
        repository: str,
        tag: str = "latest",
        artifact_type: str = "application/vnd.chiron.wheelhouse.v1.tar+gzip",
    ) -> OCIArtifactMetadata:
