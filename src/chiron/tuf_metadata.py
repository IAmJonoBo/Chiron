...
class TUFMetadata:
    ...
    def generate_root_metadata(self, version: int = 1, expires_days: int = 365) -> dict[str, Any]:
    ...
    def generate_snapshot_metadata(self, version: int = 1, expires_days: int = 7) -> dict[str, Any]:
    ...
    def generate_timestamp_metadata(self, version: int = 1, expires_hours: int = 1) -> dict[str, Any]:
    ...
    def save_metadata(self, metadata: dict[str, Any], filename: str | None = None) -> Path:
